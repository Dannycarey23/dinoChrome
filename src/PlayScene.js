...
class PlayScene extends Phaser.Scene {
  ...
  initColliders(){
    this.physics.add.collider(this.dino, this.obsticles, () => {
      ...
      const highScore = this.highScoreText.text.substr(this.highScoreText.length - 5);
...
this.restart.on('pointerdown', () => {
  ...
  this.anims.resumeAll();
    ...
    //keyup_DOWN will act as a release on the keydown_DOWN movement, resetting the dino's height.
